...
export default function RegistroProveedorModal({ visible, onClose, onRegistered }: RegistroProveedorModalProps): React.JSX.Element {
  ...
  async function handleSubmit(): Promise<void> {
    ...
    try {
      ...
      notify('Proveedor en cola', `Registro #${id} encolado para darse de alta en Hybrid.`);
      onRegistered?.(id);
      resetForm();
      onClose();
    } catch (e: any) {
          ...
          <View style={[styles.infoBanner, { backgroundColor: colors.primary + '10', borderColor: colors.primary + '30' }]}>
            ...
            <View style={styles.infoBannerTextContainer}>
              ...
              <Text style={[styles.infoBannerSub, { color: colors.textMuted }]}>
                El proveedor se dará de alta solo en el POS. Se aplica fuera de horario y aparecerá en el
                selector de Compras tras la próxima sincronización.
              </Text>
            </View>
          </View>
