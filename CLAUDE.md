...
> **CRÉDITOS — no pertenece a esta app.** Las migraciones **041/042/043** crean
> `creditos_cuenta`, `creditos_movimiento`, sus vistas `vw_creditos_*` y sus RPC.
> Viven aquí porque este repo es la fuente única del esquema Supabase, pero **la
> UI es una aplicación aparte** (cuentas por cobrar). No agregues pantallas de
> créditos a El Serrucho GO. Diseño y reglas del ledger en
